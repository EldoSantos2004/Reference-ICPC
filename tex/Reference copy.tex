\input{config.tex}
\begin{document}
	\def\title{Chamba Seekers - UNAM Facultad de Ingeniería}
	\tableofcontents\newpage
	
	\section{Funciones C++}%%%%%%%%%%%%%%%%%%ALGORITHM%%%%%%%%%%%%%%%%%%
	\input{FuncionesC++.tex}
	...
	\cppfile{data_structures/LazySegTree.cpp}
	
	\cppfile{data_structures/LazySegTree2.cpp}
	...
	\subsection{SegmentTree 2D}
	
	\cppfile{data_structures/segment_tree_2d.cpp}
	
	\subsection{DynamicSegTree}
	
	\cppfile{data_structures/dynamic_seg_tree.cpp}
	
	\subsection{OrderedSet}
	
	\cppfile{data_structures/OrderedSet.cpp}
	...
	\cppfile{data_structures/LineContainer.cpp}
	...
	\subsection{Dynammic Connectivity}
	...
	\subsection{Binary Exponentiation And Modular Division}
	...
	\cppfile{math/MillerRabinDeterministic.cpp}
