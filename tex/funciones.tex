...
\begin{tabular}{|l|l|l|}
	\hline
	\textbf{Specifier} & \textbf{Output} & \textbf{Example} \\
	\hline
	\texttt{d} or \texttt{i} & Signed decimal integer & 392 \\
	\texttt{u} & Unsigned decimal integer & 7235 \\
	\texttt{o} & Unsigned octal & 610 \\
	\texttt{x} & Unsigned hexadecimal integer & 7fa \\
	\texttt{X} & Unsigned hexadecimal integer (uppercase) & 7FA \\
	\texttt{f} & Decimal floating point, lowercase & 392.65 \\
	\texttt{F} & Decimal floating point, uppercase & 392.65 \\
	\texttt{e} & Scientific notation (mantissa/exponent), lowercase & 3.9265e+2 \\
	\texttt{E} & Scientific notation (mantissa/exponent), uppercase & 3.9265E+2 \\
	\texttt{g} & Use the shortest representation: \%e or \%f & 392.65 \\
	\texttt{G} & Use the shortest representation: \%E or \%F & 392.65 \\
	\texttt{a} & Hexadecimal floating point, lowercase & -0xc.90fep-2 \\
	\texttt{A} & Hexadecimal floating point, uppercase & -0XC.90FEP-2 \\
	\texttt{c} & Character & a \\
	\texttt{s} & String of characters & sample \\
	\texttt{p} & Pointer address & b8000000 \\
	\texttt{\%} & A \% followed by another \% will write a single \%. & \% \\
	\hline
\end{tabular}