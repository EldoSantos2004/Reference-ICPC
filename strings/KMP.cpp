/*
  ...
  pf[i]  is the length of the longest proper prefix of the substrings[0......i]$  which is also a suffix of this substring.

  For matching, one can append the string with a delimiter like $ between them
