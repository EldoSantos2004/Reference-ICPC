/*
  ...
  Splits the tree into several paths so that we can reach the root vertex from any v  by traversing at most log n paths.
  In addition, none of these paths intersect with another.
